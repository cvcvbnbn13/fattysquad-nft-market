...
import { useOwnedNFTs, useListedNFTs } from '@hooks/web3';
                        ...
                        >
                          ...
                          >
                            <span className="sr-only">
                              View details for {nft.metaData.name}
                            </span>
                          </button>
                        </div>
            ...
            <aside className="hidden w-96 bg-white p-8 border-l border-gray-200 overflow-y-auto lg:block">
              {activeNFT && (
                <div className="pb-16 space-y-6">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">戰力指數</h3>
                    <dl className="mt-2 border-t border-b border-gray-200 divide-y divide-gray-200">
                      {activeNFT.metaData.attributes.map(attr => (
                        <div
                          key={attr.trait_type}
                  ...
                  <div className="flex">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ownedNFTs.listNFT(activeNFT.tokenId, activeNFT.price);
                      }}
                      type="button"
